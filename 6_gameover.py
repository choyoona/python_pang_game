...
# 무기는 한 번에 여러 발 발사 가능
weapons = [] # 무기가 여러개 있기 떄문에 list로 정의해줘야한다
...
balls.append({
    ...
    "to_x" : 3,       # 공의 x 축 이동방향, -3이면 왼쪽 3이면 오른쪽  
    "to_y" : -6,      # y축 이동방향 
    "init_spe_y" : ball_speed_y[0]   # y의 최초 속도 
})
            ...
            if weapon_rect.colliderect(ball_rect):
                ...
                if ball_img_idx < 3 :
                    ...
                    balls.append({
                        ...
                        "pos_y" : ball_pos_y + (ball_height / 2) - (small_ball_height / 2),     # 공의 y 자표
                        "img_idx" : ball_img_idx + 1,    # 몇번째 이미지를 쓸지 / 공의 이미지 인덱스
                        "to_x" : -3,       # 공의 x 축 이동방향, -3이면 왼쪽 3이면 오른쪽  
                        "to_y" : -6,      # y축 이동방향 
                        "init_spe_y" : ball_speed_y[ball_img_idx + 1]   # y의 최초 속도 
                    })
